...
<template>
  <div>
    ...
    <el-table ref="singleTable" :data="form" style="width: 100%">
      ...
      <el-table-column align="center" property="name" label="项目名称" width="160">
        <template slot-scope="scope">
          <i style="color: #409EFF">{{ scope.row.name}}</i>
        </template>
      </el-table-column>
      <el-table-column align="center" property="times" label="项目周期" width="160"></el-table-column>
      ...
      <el-table-column align="center" property="content" label="项目介绍" min-width="100">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="操作" width="220">
        <template slot-scope="scope">
          <router-link
            ...
            target="_blank"
          >
            <el-button size="mini" plain type="primary" style="margin-right:10px">项目</el-button>
          </router-link>
    ...
    <el-dialog title="修改项目基本内容" :visible.sync="editVisible" width="45%">
      <el-form ref="formChange" :inline="true" :model="formChange">
        ...
        <el-form-item label="项目周期">
          <el-input v-model="formChange.times" style="width:500px"></el-input>
        </el-form-item>
