...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right" style="padding-bottom:20px">
      ...
      <el-breadcrumb-item>生活标签</el-breadcrumb-item>
    </el-breadcrumb>
...
export default {
  ...
  mounted() {
    ...
    // 获取标签内容
    getTypes({ typeBig: "生活随笔", nowPage: this.nowPage })
      .then(res => {
      ...
      deleteTypes({ typeId: this.id })
        .then(res => {
          ...
          if ((this.total - 1) % 5 == 0) {
            ...
            getTypes({ typeBig: "生活随笔", nowPage: this.nowPage - 1 })
              .then(res => {
                this.tableData = res.result;
              })
              .catch(res => {
